...
function App() {
  ...
  const [toast, setToast] = useState('建筑构件工坊 ready')
  ...
  useEffect(() => {
    ...
    setSelectedCell('residential')
    setSelectedOrganelle(getDefaultOrganelle('residential', customCells))
    setCompareCell(getCellProfile('residential', customCells).compareTarget)
  ...
  function handleDeleteCustomCell(cellId) {
    ...
    if (selectedCell === cellId) {
      setSelectedCell('residential')
      setSelectedOrganelle(getDefaultOrganelle('residential', nextCustomCells))
      setCompareCell(getCellProfile('residential', nextCustomCells).compareTarget)
      setInspectorOpen(false)
    }
  ...
  function handleClearWorkspaceCache() {
    ...
    setSelectedCell('residential')
    setSelectedOrganelle(getDefaultOrganelle('residential', []))
    setCompareCell(getCellProfile('residential', []).compareTarget)
  ...
  async function handleLoadProject(projectId) {
    ...
    setSelectedCell(ui.selectedCell || 'residential')
    setSelectedOrganelle(ui.selectedOrganelle || getDefaultOrganelle(ui.selectedCell || 'residential', nextCustomCells))
    setSelectedMicroscope(ui.selectedMicroscope || 'Studio Preview')
    setCompareCell(ui.compareCell || getCellProfile(ui.selectedCell || 'residential', nextCustomCells).compareTarget)
