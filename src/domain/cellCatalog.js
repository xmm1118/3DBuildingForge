...
export function getCellProfile(cellId, customCells = getStoredCustomCells()) {
  ...
  if (customCell) {
    const baseProfile = CELL_PROFILES[customCell.template] ?? CELL_PROFILES.educational
  ...
  return CELL_PROFILES[cellId] ?? CELL_PROFILES['residential']
}
...
export function inferCellTemplate(fileName) {
  ...
  if (name.includes('residential') || name.includes('house') || name.includes('dwelling')) return 'residential'
  if (name.includes('industrial') || name.includes('factory') || name.includes('warehouse')) return 'industrial'
  if (name.includes('office') || name.includes('tower') || name.includes('skyscraper')) return 'office'
  if (name.includes('medical') || name.includes('hospital') || name.includes('clinic')) return 'medical'
  if (name.includes('cultural') || name.includes('museum') || name.includes('theater')) return 'cultural'
  if (name.includes('commercial') || name.includes('mall') || name.includes('retail')) return 'commercial'
  return 'educational'
}
