export const ASSET_CATEGORIES = [
  ...
  },
  {
    ...
    keywords: ['building', 'architecture', 'structure', 'construction', 'residential', 'commercial', 'office', 'cultural', 'industrial', 'educational', 'medical', '建筑', '构件', '结构', '住宅', '商业', '办公', '文化', '工业', '教育', '医疗'],
